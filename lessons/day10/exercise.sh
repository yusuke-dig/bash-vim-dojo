...
# YOUR CODE HERE
greeting="Hello, Phase1!"
echo "$greeting" > result_task1.txt
...
# YOUR CODE HERE
mkdir -p work
touch work/a.sh work/b.sh
find work -name "*.sh" | wc -l > result_task5.txt
