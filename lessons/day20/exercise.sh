...
# YOUR CODE HERE
echo "Hello world" | sed 's/world/Bash/' > result_task1.txt
...
# YOUR CODE HERE
echo "Alice 90 Math" | awk '{print $1 ": " $2}' > result_task2.txt
...
# YOUR CODE HERE
{ echo "ok"; cat no_such_file.txt; } 2>/dev/null > result_task4.txt
...
} && to_upper "hello" > result_task5.txt
